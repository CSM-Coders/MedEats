...
class Restaurant(models.Model):
    ...
    rating = models.DecimalField(max_digits=3, decimal_places=1, null=True, blank=True, verbose_name="Calificación")
    ...
    image = models.URLField(max_length=500, null=True, blank=True, verbose_name="URL de la Imagen")
    ...
    menu_highlights = models.JSONField(default=list, blank=True, verbose_name="Platos Destacados")
    
    # Número de contacto. Es CharField porque los números de teléfono pueden tener "+", "()", o espacios.
    whatsapp = models.CharField(max_length=50, blank=True, verbose_name="Número de WhatsApp")
